...
#Uso del cinturon
DBVL$CinSeg
DBVL$USOCINTURON <-(ifelse((DBVL$CinSeg == 2),1,0))
DBVL$NOUSOCINTURON <-(ifelse((DBVL$CinSeg == 1),1,0))

#Uso dispositivos
DBVL$USODISPMOB <- (ifelse((DBVL$DispMob != 1 ),1,0))
DBVL$NOUSODISPMOB <- (ifelse((DBVL$DispMob ==1),1,0))
...
STRESS ~ EDUBASICA + JOVEN30 + ADULTO40 + ADULTO60 + TIEMPO_PROFESION + HORASTRABAJO + HPICO + CSECO +
CONG_CD + CONG_EF + SININFOTRF + USOCINTURON + USODISPMOB + HABPROSOC
...
# Regresiones
ACTAGR ~ EDUBASICA + JOVEN30 + ADULTO40 + ADULTO60 + TIEMPO_PROFESION + HORASTRABAJO + HPICO + CSECO +
CONG_CD + CONG_EF + SININFOTRF + USOCINTURON + USODISPMOB + STRESS
...
HABPROSOC ~ EDUBASICA + JOVEN30 + ADULTO40 + ADULTO60 + TIEMPO_PROFESION + HORASTRABAJO + HPICO + CSECO +
CONG_CD + CONG_EF + SININFOTRF + USOCINTURON + USODISPMOB + AMBLABOR
...
# Regresiones
ACTAGR ~ EDUBASICA + JOVEN30 + ADULTO40 + HORASTRABAJO  + CSECO +
CONG_CD + CONG_EF + USOCINTURON  + STRESS

STRESS ~ JOVEN30 + ADULTO40 + ADULTO60 + HORASTRABAJO + CONG_CD + CONG_EF + 
SININFOTRF + USODISPMOB + HABPROSOC

AMBLABOR ~ EDUBASICA + ADULTO40 + ADULTO60 + HORASTRABAJO + HPICO +
CONG_CD + CONG_EF + USOCINTURON + USODISPMOB

HABPROSOC ~ ADULTO40 + ADULTO60 + HORASTRABAJO + CSECO + CONG_EF +
USOCINTURON + AMBLABOR
