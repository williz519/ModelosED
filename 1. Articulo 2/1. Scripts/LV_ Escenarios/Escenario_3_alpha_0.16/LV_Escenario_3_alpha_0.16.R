...
sink("Modelo_Dos_Factores_alpha_0.16.txt")
...
FA_2 ~ EDUBASICA + EXP_2 + CONG_CD + CONG_EF + USOCINTURON + USODISPMOB
...
sink("Modelo_Tres_Factores_alpha_0.16.txt")
...
FA_3 ~ EDUBASICA + JOVEN30 + EXP_2 + HTRB_2  + HTRB_3 + CONG_CD + USOCINTURON + USODISPMOB
