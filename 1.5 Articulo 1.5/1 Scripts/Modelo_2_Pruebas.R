...
dt$Camaras <- (ifelse(dt$CHOICE ==1, (ifelse(dt$CamFD_A1 > 0,1,0)),
                      (ifelse(dt$CHOICE == 2, (ifelse(dt$CamFD_A2 > 0,1,0)),
                             (ifelse(dt$CHOICE == 3, (ifelse(dt$CamFD_A3 > 0,1,0)),
                                    ((ifelse(dt$CamFD_EC > 0,1,0)))))))))

dt$Camaras <- factor(dt$Camaras,
                       levels = 0:1,
                       labels = c("No","Si"))
dt$Camaras
dt$Camaras <- relevel(dt$Camaras, ref = "No")
...
dt$Camaras_Si <- (ifelse((dt$Camaras == "Si"),1,0))
dt$Camaras_No <- (ifelse((dt$Camaras == "No"),1,0))
