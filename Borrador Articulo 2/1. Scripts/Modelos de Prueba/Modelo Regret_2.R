...
apollo_fixed = c("asc_ruta3", "b_CongAB", "b_ACC_0")

#"b_No_MTRP", "b_NO_PANEL", "b_NO_ZER"
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  R[['ruta1']]  = asc_ruta1  + 
    max(0,b_tt*(T_Alt_2 - T_Alt_1)) + 
    max(0,b_tt*(T_Alt_3  - T_Alt_1)) + 
    max(0,b_tt*(T_Alt_4   - T_Alt_1)) + 
    max(0,b_dt*(D_Alt_2 - D_Alt_1)) + 
    max(0,b_dt*(D_Alt_3 - D_Alt_1)) +
    max(0,b_dt*(D_Alt_4 - D_Alt_1)) +
    max(0,b_Sem*(RSem_ruta2  - RSem_ruta1))  + 
    max(0,b_Sem*(RSem_ruta3  - RSem_ruta1))  + 
    max(0,b_Sem*(RSem_ruta4  - RSem_ruta1)) +
    max(0,(RCong_ruta2  - RCong_ruta1))  +
    max(0,(RCong_ruta3  - RCong_ruta1))  +
    max(0,(RCong_ruta4  - RCong_ruta1))  +
    max(0,(RAcc_ruta2  - RAcc_ruta1))  +
    max(0,(RAcc_ruta3  - RAcc_ruta1))  +
    max(0,(RAcc_ruta4  - RAcc_ruta1)) 
    #max(0,(RCamFd_ruta2 - RCamFd_ruta1)) +
    #max(0,(RCamFd_ruta3 - RCamFd_ruta1)) +
    #max(0,(RCamFd_ruta4 - RCamFd_ruta1)) +
    #max(0,(RPanel_ruta2 - RPanel_ruta1)) +
    #max(0,(RPanel_ruta3 - RPanel_ruta1)) +
    #max(0,(RPanel_ruta4 - RPanel_ruta1)) +
    #max(0,(RZer_r2 - RZer_r1)) +
    #max(0,(RZer_r3 - RZer_r1)) +
    #max(0,(RZer_r4 - RZer_r1)) +
    #max(0,(RMtrp_r2 - RMtrp_r1)) +
    #max(0,(RMtrp_r3 - RMtrp_r1)) +
    #max(0,(RMtrp_r4 - RMtrp_r1))
  
  R[['ruta2']]  = asc_ruta2  + 
    max(0,b_tt*(T_Alt_1 - T_Alt_2)) + 
    max(0,b_tt*(T_Alt_3 - T_Alt_2)) + 
    max(0,b_tt*(T_Alt_4 - T_Alt_2)) + 
    max(0,b_dt*(D_Alt_1 - D_Alt_2)) + 
    max(0,b_dt*(D_Alt_3 - D_Alt_2)) +
    max(0,b_dt*(D_Alt_4 - D_Alt_2)) +
    max(0,b_Sem*(RSem_ruta1  - RSem_ruta2)) +
    max(0,b_Sem*(RSem_ruta3  - RSem_ruta2)) + 
    max(0,b_Sem*(RSem_ruta4  - RSem_ruta2)) +
    max(0,(RCong_ruta1  - RCong_ruta2))  +
    max(0,(RCong_ruta3  - RCong_ruta2))  +
    max(0,(RCong_ruta4  - RCong_ruta2))  +
    max(0,(RAcc_ruta1  - RAcc_ruta2))  +
    max(0,(RAcc_ruta3  - RAcc_ruta2))  +
    max(0,(RAcc_ruta4  - RAcc_ruta2)) 
    #max(0,(RCamFd_ruta1 - RCamFd_ruta2)) +
    #max(0,(RCamFd_ruta3 - RCamFd_ruta2)) +
    #max(0,(RCamFd_ruta4 - RCamFd_ruta2)) +
    #max(0,(RPanel_ruta1 - RPanel_ruta2)) +
    #max(0,(RPanel_ruta3 - RPanel_ruta2)) +
    #max(0,(RPanel_ruta4 - RPanel_ruta2)) +
    #max(0,(RZer_r1 - RZer_r2)) +
    #max(0,(RZer_r3 - RZer_r2)) +
    #max(0,(RZer_r4 - RZer_r2)) +
    #max(0,(RMtrp_r1 - RMtrp_r2)) +
    #max(0,(RMtrp_r3 - RMtrp_r2)) +
    #max(0,(RMtrp_r4 - RMtrp_r2))
  
  R[['ruta3']]  = asc_ruta3  + 
    max(0,b_tt*(T_Alt_1 - T_Alt_3)) + 
    max(0,b_tt*(T_Alt_2 - T_Alt_3)) + 
    max(0,b_tt*(T_Alt_4 - T_Alt_3)) + 
    max(0,b_dt*(D_Alt_1 - D_Alt_3)) + 
    max(0,b_dt*(D_Alt_2 - D_Alt_3)) +
    max(0,b_dt*(D_Alt_4 - D_Alt_3)) +
    max(0,b_Sem*(RSem_ruta1  - RSem_ruta3))  + 
    max(0,b_Sem*(RSem_ruta2  - RSem_ruta3))  + 
    max(0,b_Sem*(RSem_ruta4  - RSem_ruta3)) +
    max(0,(RCong_ruta2  - RCong_ruta3))  +
    max(0,(RCong_ruta1  - RCong_ruta3))  +
    max(0,(RCong_ruta4  - RCong_ruta3))  +
    max(0,(RAcc_ruta1  - RAcc_ruta3))  +
    max(0,(RAcc_ruta2  - RAcc_ruta3))  +
    max(0,(RAcc_ruta4  - RAcc_ruta3)) 
    #max(0,(RCamFd_ruta1 - RCamFd_ruta3)) +
    #max(0,(RCamFd_ruta2 - RCamFd_ruta3)) +
    #max(0,(RCamFd_ruta4 - RCamFd_ruta3)) +
    #max(0,(RPanel_ruta1 - RPanel_ruta3)) +
    #max(0,(RPanel_ruta2 - RPanel_ruta3)) +
    #max(0,(RPanel_ruta4 - RPanel_ruta3)) +
    #max(0,(RZer_r1 - RZer_r3)) +
    #max(0,(RZer_r2 - RZer_r3)) +
    #max(0,(RZer_r4 - RZer_r3)) +
    #max(0,(RMtrp_r1 - RMtrp_r3)) +
    #max(0,(RMtrp_r2 - RMtrp_r3)) +
    #max(0,(RMtrp_r4 - RMtrp_r3))
  
  
  R[['ruta4']]  = asc_ruta4  + 
    max(0,b_tt*(T_Alt_1 - T_Alt_4)) + 
    max(0,b_tt*(T_Alt_2 - T_Alt_4)) + 
    max(0,b_tt*(T_Alt_3 - T_Alt_4)) + 
    max(0,b_dt*(D_Alt_1 - D_Alt_4)) + 
    max(0,b_dt*(D_Alt_2 - D_Alt_4)) +
    max(0,b_dt*(D_Alt_3 - D_Alt_4)) +
    max(0,b_Sem*(RSem_ruta1  - RSem_ruta4))  + 
    max(0,b_Sem*(RSem_ruta2  - RSem_ruta4))  + 
    max(0,b_Sem*(RSem_ruta3  - RSem_ruta4)) +
    max(0,(RCong_ruta1  - RCong_ruta4))  +
    max(0,(RCong_ruta1  - RCong_ruta4))  +
    max(0,(RCong_ruta3  - RCong_ruta4))  +
    max(0,(RAcc_ruta1  - RAcc_ruta4))  +
    max(0,(RAcc_ruta2  - RAcc_ruta4)) +
    max(0,(RAcc_ruta3  - RAcc_ruta4)) 
    #max(0,(RCamFd_ruta1 - RCamFd_ruta4)) +
    #max(0,(RCamFd_ruta2 - RCamFd_ruta4)) +
    #max(0,(RCamFd_ruta3 - RCamFd_ruta4)) +
    #max(0,(RPanel_ruta1 - RPanel_ruta4)) +
    #max(0,(RPanel_ruta2 - RPanel_ruta4)) +
    #max(0,(RPanel_ruta3 - RPanel_ruta4)) +
    #max(0,(RZer_r1 - RZer_r4)) +
    #max(0,(RZer_r2 - RZer_r4)) +
    #max(0,(RZer_r3 - RZer_r4)) +
    #max(0,(RMtrp_r1 - RMtrp_r4)) +
    #max(0,(RMtrp_r2 - RMtrp_r4)) +
    #max(0,(RMtrp_r3 - RMtrp_r4))
