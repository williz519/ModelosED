...
apollo_control = list(
  modelName  = "ICLV_Conjunto_6F",
  modelDescr = "ICLV Conjunto de 6F",
  indivID    = "ViajeId",
  mixing     = TRUE,
  nCores     = 3
)
...
apollo_beta=c(asc_ruta1   = 0, asc_ruta2   = 0, asc_ruta3   = 0, asc_ruta4  = 0,
              ...
              # Regresion LV1
              g_JOVEN30_LV1 = -0.382,
              g_ADULTO40_LV1 = -0.310,
              g_ADULTO60_LV1 = -0.266,
              g_LV4_LV1 = 0.550,
              #g_EXP_3_LV1 = -0.408,
              #g_EXP_4_LV1 = -0.180,
              #g_HTRB_2_LV1 = 0.311,
              ...
              # Regresion LV3
              g_EDUBASICA_LV3 = -0.384,
              g_JOVEN30_LV3 = -0.323,
              g_EXP_2_LV3 = 0.287,
              g_USODISPMOB_LV3 = -0.286,
              ...
              # Regresion LV4
              g_JOVEN30_LV4 = 0.475,
              g_ADULTO40_LV4 = 0.303,
              g_ADULTO60_LV4 = 0.389,
              g_USODISPMOB_LV4 = 0.200,
              g_LV6_LV4 = 0.546,
              #g_EXP_2_LV4 = -0.481,
              #g_EXP_3_LV4 = -0.402,
              ...
              # Regresion LV5
              g_EDUBASICA_LV5 = 0.248,
              g_EXP_2_LV5 = 0.521,
              g_EXP_4_LV5 = 0.387,
              g_EXP_5_LV5 = 0.374,
              g_USODISPMOB_LV5 = 0.250,
              #g_JOVEN30_LV5 = -0.469,
              #g_ADULTO40_LV5 = -0.295,
              #g_EXP_2_LV5 = 0.365,
              #g_HTRB_2_LV5 = -0.262,
...
apollo_fixed = c("asc_ruta3", "b_CongAB", "b_ACC_0", "b_NO_CAMFD", "b_No_MTRP", "b_NO_PANEL", 
                 "b_NO_ZER",
                 "g_JOVEN30_LV1",
                 "g_ADULTO40_LV1",
                 "g_ADULTO60_LV1",
...
apollo_draws = list(
  ...
  interNDraws=100,          
  interUnifDraws=c(),      
  interNormDraws=c("eta1","eta2","eta3", "eta4","eta5","eta6")
)
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["LV_6"]] = g_EXP_3_LV6*EXP_3 + g_SININFOTRF_LV6 *SININFOTRF + eta6
  
  randcoeff[["LV_4"]] =  g_JOVEN30_LV4*JOVEN30 + g_ADULTO40_LV4*ADULTO40 + g_ADULTO60_LV4*ADULTO60 + 
    g_USODISPMOB_LV5*USODISPMOB + g_LV6_LV4*randcoeff[["LV_6"]] + eta4
  
  randcoeff[["LV_1"]] = g_JOVEN30_LV1*JOVEN30 + g_ADULTO40_LV1*ADULTO40 + 
    g_ADULTO60_LV4*ADULTO60 + g_LV4_LV1*randcoeff[["LV_4"]]
  
  randcoeff[["LV_2"]] = g_HPICO_LV2*HPICO + g_CSECO_LV2*CSECO + g_LV1_LV2*randcoeff[["LV_1"]] + eta2
  
  randcoeff[["LV_3"]] = g_EDUBASICA_LV3*EDUBASICA + g_JOVEN30_LV3*JOVEN30 + 
    g_EXP_2_LV3*EXP_2 + g_USODISPMOB_LV5*USODISPMOB + eta3
  
  randcoeff[["LV_5"]] = g_EDUBASICA_LV5*EDUBASICA + g_EXP_2_LV5*EXP_2 + g_EXP_4_LV5*EXP_4 +
    g_EXP_5_LV5*EXP_5 + g_USODISPMOB_LV5*USODISPMOB + eta5
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ol_settings13 = list(outcomeOrdered=PrPer, 
                       V=zeta_PrPer * LV_5, 
                       tau=c(tau_PrPer_1, tau_PrPer_2, tau_PrPer_3, tau_PrPer_4))
  ol_settings14 = list(outcomeOrdered=AmbTr, 
                       V=zeta_AmbTr * LV_5, 
                       tau=c(tau_AmbTr_1, tau_AmbTr_2, tau_AmbTr_3, tau_AmbTr_4))
  
  
  ol_settings15 = list(outcomeOrdered=Ans, 
                      V=zeta_Ans * LV_4, 
                      tau=c(tau_Ans_1, tau_Ans_2, tau_Ans_3, tau_Ans_4))
  ol_settings16 = list(outcomeOrdered=StrC, 
                       V=zeta_StrC * LV_4, 
  ...
  P[["indic_PrPer"]]    = apollo_ol(ol_settings13, functionality)
  P[["indic_AmbTr"]]    = apollo_ol(ol_settings14, functionality)
  
  P[["indic_Ans"]]      = apollo_ol(ol_settings15, functionality)
  P[["indic_StrC"]]     = apollo_ol(ol_settings16, functionality)
