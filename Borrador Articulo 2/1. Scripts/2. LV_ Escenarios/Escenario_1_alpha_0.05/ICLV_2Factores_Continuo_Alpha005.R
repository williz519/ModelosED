...
database = read.csv("/Users/williz/Desktop/ModelosED/Database/DBMuestra_ModeloLogitVL.csv",sep="\t", dec=".",header=TRUE)
...
apollo_beta=c(asc_ruta1   = 0, asc_ruta2   = 0, asc_ruta3   = 0, asc_rutaEC  = 0,
              b_time      = 0, b_dist      = 0, b_CongAB    = 0, b_CongCD    = 0,
              b_CongEF      = 0,
              ...
              lambda_1       = 1,
              lambda_2       = 1,
              gamma_USOCINTURON = -0.313,
              gamma_USOCINTURON_2 = 0.365,
              gamma_USODISPMOB = 0.216,
              gamma_USODISPMOB_2 = - 0.253,
              gamma_EDUBASICA = -0.256,
              gamma_JOVEN30 = - 0.214,
              gamma_EXP_2 = 0.215,
              gamma_LV_1 = 0.124,
              zeta_FRbr     = 1, 
...
#gamma_USOCINTURON  = 0,gamma_EDUBASICA = 0,gamma_EXP_2   = 0,gamma_USODISPMOB  = 0,gamma_JOVEN30 = 0,
#gamma_LV_1   = 0,
...
apollo_fixed = c("asc_rutaEC", "b_EduSuperior", "b_AdultoMayor","b_Exp_5","b_HTRB_1","b_Hvalle",
                 ...
                 "gamma_USOCINTURON","gamma_USOCINTURON_2","gamma_USODISPMOB", "gamma_USODISPMOB_2",
                 "gamma_EDUBASICA", "gamma_JOVEN30", "gamma_EXP_2", "gamma_LV_1") 

#"sigma_FRbr", 
#                 "sigma_PasoPeaton", "zeta_EnfCond", "zeta_AFrSem","zeta_CulFr","zeta_OmLmVel",
#                 "zeta_IgPare","zeta_UsoCel","zeta_PasoPeaton","zeta_UsoDirec")
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["LV_2"]] = gamma_EDUBASICA * EDUBASICA + gamma_JOVEN30  * JOVEN30 + gamma_EXP_2 * EXP_2 + 
    gamma_USOCINTURON_2 * USOCINTURON + gamma_USODISPMOB_2 * USODISPMOB + gamma_LV_1 * randcoeff[["LV_1"]] + eta2
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['ruta1']]  = (asc_ruta1  + b_time * TIEMPOAlt1 + b_dist * DISTAlt1 + b_CongAB * CONG_AB_A1 +
                     b_CongCD * CONG_CD_A1 + b_CongEF * CONG_EF_A1 + b_Sem_0 * SEMF_A1_0 + 
  ...
  V[['ruta2']]  = (asc_ruta2  + b_time * TIEMPOAlt2 + b_dist * DISTAlt2 + b_CongAB * CONG_AB_A2 +
  ...
  V[['ruta3']]  = (asc_ruta3  + b_time * TIEMPOAlt3 + b_dist * DISTAlt3 + b_CongAB * CONG_AB_A3 +
                     b_CongCD * CONG_CD_A3 + b_CongEF * CONG_EF_A3 + b_Sem_0 * SEMF_A3_0 + b_Sem_1 * SEMF_A3_1 + b_Sem_2 * SEMF_A3_2 + b_Sem_3 * SEMF_A3_3 +
  ...
  V[['rutaEC']] = (asc_rutaEC + b_time * TIEMPOEC   + b_dist * DISTEC + b_CongAB * CONG_AB_EC +
                     b_CongCD * CONG_CD_EC + b_CongEF * CONG_EF_EC + b_Sem_0 * SEMF_EC_0 + 
                     b_Sem_1 * SEMF_EC_1 + b_Sem_2 * SEMF_EC_2 + b_Sem_3 * SEMF_EC_3 + b_Sem_4  * SEMF_EC_4 +
