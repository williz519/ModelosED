...
DBModLog <- read.csv("/Users/williz/Desktop/ModelosED/1. Articulo 2/2. Database/DBMuestra_ModeloLogitVL.csv", header = TRUE, sep = "\t")
...
workingDirectory="/Users/williz/Desktop/ModelosED/1. Articulo 2/1. Scripts/2. LV_ Escenarios/Escenario_4_alpha_0.20"
setwd(workingDirectory)

sink("Modelo_Muestra_Dos_Factores_alpha_02.txt")

# MODELO 1 Dos Factores alpha 0.2 t value= 1.28
...
# Regresiones
FA_1 ~  USOCINTURON + USODISPMOB + JOVEN30 + ADULTO40 
...
model1_3 <- " #Variables Latentes
      FA_1 =~ FRbr + EnfCond + AFrSem + CulFr + OmLmVel + IgPare + UsoCel
      FA_2 =~ PasoPeaton + UsoDirec + CulFr
...
sink("Modelo_Muestra_Tres_Factores_alpha_02.txt")

# MODELO 2: Tres Factores alpha 0.16 t value= 1.28
...
# Regresiones
FA_1 ~ USOCINTURON + USODISPMOB + JOVEN30 + EXP_3 + CSECO 
FA_2 ~ ADULTO40 + JOVEN30 + EXP_1 + HPICO + USOCINTURON + USODISPMOB
...
# Regresiones
FA_1 ~ USOCINTURON + USODISPMOB + EXP_3 + CSECO 
FA_2 ~ ADULTO40 + JOVEN30 + EXP_1 + HPICO + USOCINTURON + USODISPMOB
FA_3 ~ EDUBASICA + JOVEN30 + ADULTO40 + EXP_2 + HTRB_2 + HTRB_3 + HTRB_4 + 
USOCINTURON + USODISPMOB
FA_2 ~ FA_1
...
# Regresiones
FA_1 ~ USOCINTURON + USODISPMOB + EXP_3 + CSECO 
FA_2 ~ ADULTO40 + EXP_1 + HPICO + USOCINTURON + USODISPMOB
FA_3 ~ EDUBASICA + JOVEN30 + ADULTO40 + EXP_2 + HTRB_2 + HTRB_3 + HTRB_4 + 
USOCINTURON + USODISPMOB
FA_2 ~ FA_1
FA_3 ~ FA_2
