...
workingDirectory="/Users/williz/Desktop/ModelosED/1. Articulo 2/1. Scripts/2. LV_ Escenarios/Escenario_3_alpha_0.16"
setwd(workingDirectory)

sink("Modelo_Muestra_Dos_Factores_alpha_016.txt")

# MODELO 1 Dos Factores alpha 0.16 t value= 1.4
...
sink("Modelo_Muestra_Tres_Factores_alpha_016.txt")

# MODELO 2: Tres Factores alpha 0.16 t value= 1.4
...
# Regresiones
FA_1 ~ USOCINTURON + USODISPMOB 
FA_2 ~ ADULTO40 + EXP_1 + HPICO + USOCINTURON 
FA_3 ~ EDUBASICA + JOVEN30 + ADULTO40 + EXP_2 + HTRB_2 + HTRB_3 + HTRB_4 + 
USOCINTURON + USODISPMOB
FA_2 ~ FA_1
