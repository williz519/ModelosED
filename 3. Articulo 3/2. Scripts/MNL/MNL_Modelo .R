...
workingDirectory="/Users/williz/Desktop/ModelosED/3. Articulo 3/4. Resultados/MNL"
...
apollo_control = list(
  modelName  = "MNL_Modelo Art3",
  modelDescr = "Modelo MNL Art3",
  indivID    = "ViajeId",
  nCores     = 1
)
...
apollo_prepareProb(P, apollo_inputs, functionality = "output")
