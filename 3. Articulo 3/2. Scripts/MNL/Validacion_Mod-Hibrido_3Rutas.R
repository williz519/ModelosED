...
LV_2 = ce[31]*db$ADULTO40 + ce[32]*db$EXP_3 + ce[33]*db$EXP_4 +
  ce[34]*db$EXP_5 + ce[35]*db$HPICO + ce[36] * db$USODISPMOB 

LV_1 = ce[25]*db$EDUBASICA + ce[26]*db$EDUSUP + ce[27]*db$HPICO + 
  ce[28]*db$CSECO + ce[29]*db$SININFOTRF + ce[30]*LV_2 

LV_3 = ce[37]*db$EDUBASICA + ce[38]*db$JOVEN30 + ce[39]*db$ADULTO40 +
  ce[40]*db$EXP_2 + ce[41] * db$USODISPMOB 
...
V_4 = ce[3] + ce[4] * db$T_Alt_4*(1 + db$CG_Alt_4) + ce[5] * db$D_Alt_4 + 
  ce[6] * db$SEM_EC_km +
  ce[7] * db$ACC_EC_0 + ce[8] * db$ACC_EC_1 + ce[9] * db$ACC_EC_2 + 
  ...
  ce[22] * LV_1 + ce[23] * LV_2 + ce[24] * LV_3
...
LVT_2 = ce[31]*db$ADULTO40 + ce[32]*db$EXP_3 + ce[33]*db$EXP_4 +
  ce[34]*db$EXP_5 + ce[35]*db$HPICO + ce[36] * db$USODISPMOB 

LVT_1 = ce[25]*db$EDUBASICA + ce[26]*db$EDUSUP + ce[27]*db$HPICO + 
  ce[28]*db$CSECO + ce[29]*db$SININFOTRF + ce[30]*LVT_2 

LVT_3 = ce[37]*db$EDUBASICA + ce[38]*db$JOVEN30 + ce[39]*db$ADULTO40 +
  ce[40]*db$EXP_2 + ce[41] * db$USODISPMOB
...
VT_4 = ce[3] + ce[4] * db$T_Alt_4*(1 + db$CG_Alt_4) + ce[5] * db$D_Alt_4 + 
  ...
  ce[18] * db$SININFOTRF + ce[19] * db$CONINFOTRF + 
  ce[20] * db$UsoCel_Poco +  ce[21] * db$UsoCel_Frec +
  ce[22] * LVT_1 + ce[23] * LVT_2 + ce[24] * LVT_3
