...
workingDirectory="/Users/williz/Desktop/ModelosED/3. Articulo 3/2. Scripts/Modelos/MNL/MNL_Modelo"
...
database = read.csv("/Users/williz/Desktop/ModelosED/3. Articulo 3/3. Database/DBMuestraArt3.csv",sep="\t", dec=".",header=TRUE)
