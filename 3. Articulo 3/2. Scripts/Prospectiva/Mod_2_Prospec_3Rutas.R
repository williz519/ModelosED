...
workingDirectory="/Users/williz/Desktop/ModelosED/3. Articulo 3/4. Resultados/Prospectiva/3Rutas/Modelo_2"
...
apollo_control = list(
  modelName  = "Modelo_2_Prospec_Simple_3Rutas",
...
for (i in 1:nrow(database)){ 
  ...
  phi   = 0.18
  theta = 0
  eta   = 0.15         # 0.18 Estan Calibrados ... No Cambiar
  eta1  = 0.0        # 0.20
