...
resultados <-  read.csv("/Users/williz/Desktop/ModelosED/3. Articulo 3/4. Resultados/Prospectiva/3Rutas/Modelo_1/Modelo_1_Prospec_Simple_3Rutas_estimates.csv",sep=",", dec=".",header=TRUE )
