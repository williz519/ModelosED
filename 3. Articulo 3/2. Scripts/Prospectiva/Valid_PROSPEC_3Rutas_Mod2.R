...
resultados <-  read.csv("/Users/williz/Desktop/ModelosED/3. Articulo 3/4. Resultados/Prospectiva/3Rutas/Modelo_2/Modelo_2_Prospec_Simple_3Rutas_estimates.csv",sep=",", dec=".",header=TRUE )
