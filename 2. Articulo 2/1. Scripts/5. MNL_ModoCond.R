...
apollo_fixed = c("asc_rutaEC","b_Exper_1","b_Sem_0", "b_NO_CAMFD","b_ACC_0","b_NO_PANEL","b_NO_ZER" )
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['rutaEC']] = asc_rutaEC + b_time * TIEMPOEC   + b_dist * DISTEC   + b_cong * CONGESTION +
    ...
    b_EduBasica * EDUBASICA + b_EduSuperior * EDUSUP + b_Joven30 * JOVEN30 + b_Adulto40 * ADULTO40 + 
