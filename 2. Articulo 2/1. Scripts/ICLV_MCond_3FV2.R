...
registros <- createDataPartition(database$CHOICE, p = 0.81, list = FALSE)
...
LV_2 = lastFuncParam[24]*db$ADULTO40 + lastFuncParam[25]*db$EXP_3 + lastFuncParam[26]*db$EXP_4 +
  lastFuncParam[27]*db$EXP_5 + lastFuncParam[28]*db$HPICO + lastFuncParam[29] * db$USODISPMOB + eta2

LV_1 = lastFuncParam[18]*db$EDUBASICA + lastFuncParam[19]*db$EDUSUP + lastFuncParam[20]*db$HPICO + 
  lastFuncParam[21]*db$CSECO + lastFuncParam[22]*db$SININFOTRF + lastFuncParam[23]*LV_2 + eta1

LV_3 = lastFuncParam[30]*db$EDUBASICA + lastFuncParam[31]*db$JOVEN30 + lastFuncParam[32]*db$ADULTO40 +
  lastFuncParam[33]*db$EXP_2 + lastFuncParam[34] * db$USODISPMOB + eta3
...
LVT_2 = lastFuncParam[24]*db$ADULTO40 + lastFuncParam[25]*db$EXP_3 + lastFuncParam[26]*db$EXP_4 +
  lastFuncParam[27]*db$EXP_5 + lastFuncParam[28]*db$HPICO + lastFuncParam[29] * db$USODISPMOB + etaT2

LVT_1 = lastFuncParam[18]*db$EDUBASICA + lastFuncParam[19]*db$EDUSUP + lastFuncParam[20]*db$HPICO + 
  lastFuncParam[21]*db$CSECO + lastFuncParam[22]*db$SININFOTRF + lastFuncParam[23]*LVT_2 + etaT1

LVT_3 = lastFuncParam[30]*db$EDUBASICA + lastFuncParam[31]*db$JOVEN30 + lastFuncParam[32]*db$ADULTO40 +
  lastFuncParam[33]*db$EXP_2 + lastFuncParam[34] * db$USODISPMOB + etaT3
