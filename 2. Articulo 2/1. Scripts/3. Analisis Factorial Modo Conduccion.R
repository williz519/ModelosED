...
#ModoCond$Suma <- ModoCond$FRbr+ModoCond$UsoDirec+ModoCond$EnfCond+
#  ModoCond$AFrSem+ModoCond$CulFr+ModoCond$OmLmVel+ ModoCond$IgPare+ModoCond$UsoCel+
#  ModoCond$INFOTRAFICO+ModoCond$DispMob+ModoCond$Experiencia+ModoCond$CinSeg+
#  ModoCond$PasoPeaton+ModoCond$UsoPito

cor(ModoCond)

#ModoCond[c("Suma","CinSeg","DispMob","Experiencia")]<-NULL

#ModoCond$Suma <- ModoCond$FRbr+ModoCond$UsoDirec+ModoCond$EnfCond+
#  ModoCond$AFrSem+ModoCond$CulFr+ModoCond$OmLmVel+ ModoCond$IgPare+ModoCond$UsoCel+
#  ModoCond$INFOTRAFICO+ModoCond$Experiencia+
#  ModoCond$PasoPeaton+ModoCond$UsoPito
