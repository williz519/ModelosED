...
est= read.csv("/Users/williz/Desktop/ModelosED/2. Articulo 2/1. Scripts/Modelos MNL/MNL_Modelo_2/MNL_Modelo_2_1 Sin la ruta 3_estimates.csv",sep=",", dec=".",header=TRUE
)
