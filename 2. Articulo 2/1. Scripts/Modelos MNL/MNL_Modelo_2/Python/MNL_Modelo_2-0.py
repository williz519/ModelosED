...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 12 19:08:53 2020
...
V1 = asc_ruta1 + b_TT * TIEMPOAlt1 + b_DT * DISTAlt1 + b_CongAB*CONG_AB_A1 +\
     ...
     b_Sem_1 * SEMF_A1_1 + b_Sem_2 * SEMF_A1_2 + b_Sem_3 * SEMF_A1_3 + b_ACC_0* ACC_A1_0 +\
     b_ACC_1 * ACC_A1_1 + b_ACC_2*ACC_A1_2

V2 = asc_ruta2 + b_TT*TIEMPOAlt2 + b_DT*DISTAlt2 + b_CongAB*CONG_AB_A2 +\
     b_CongCD*CONG_CD_A2 + b_CongEF*CONG_EF_A2  +\
     b_Sem_1*SEMF_A2_1 + b_Sem_2*SEMF_A2_2 + b_Sem_3*SEMF_A2_3  + b_ACC_0*ACC_A2_0 +\
     b_ACC_1*ACC_A2_1 + b_ACC_2*ACC_A2_2

V3 = asc_ruta3 + b_TT*TIEMPOAlt3 + b_DT*DISTAlt3 + b_CongAB*CONG_AB_A3 +\
     b_CongCD*CONG_CD_A3 + b_CongEF*CONG_EF_A3 +\
     b_Sem_1*SEMF_A3_1 + b_Sem_2*SEMF_A3_2 + b_Sem_3*SEMF_A3_3 + b_ACC_0*ACC_A3_0 +\
     b_ACC_1*ACC_A3_1 + b_ACC_2*ACC_A3_2

V4 = asc_rutaEC + b_TT*TIEMPOEC + b_DT*DISTEC + b_CongAB*CONG_AB_EC +\
     b_CongCD*CONG_CD_EC + b_CongEF*CONG_EF_EC +\
     b_Sem_1*SEMF_EC_1 + b_Sem_2*SEMF_EC_2 + b_Sem_3*SEMF_EC_3 + b_ACC_0*ACC_EC_0 +\
     b_ACC_1*ACC_EC_1 + b_ACC_2*ACC_EC_2
...
biogeme.modelName = "MNL_Modelo_2-0"
