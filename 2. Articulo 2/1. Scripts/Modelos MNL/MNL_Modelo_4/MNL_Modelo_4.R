...
workingDirectory="/Users/williz/Desktop/ModelosED/1. Articulo 2/1. Scripts/Modelos MNL/MNL_Modelo_4"
...
apollo_fixed = c("asc_ruta1", "b_CongEF", "b_Sem_3", "b_ACC_2",
                 "b_NO_CAMFD", "b_NO_PANEL", "b_SI_ZER", "b_EdSuperior",
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  b_SI_PANEL* SI_PANEL_A1 + b_NO_ZER * NO_PANEL_A1
  ...
  b_SI_PANEL* SI_PANEL_A2 + b_NO_ZER * NO_PANEL_A2
  ...
  b_SI_PANEL* SI_PANEL_A3 + b_NO_ZER * NO_PANEL_A3
  ...
  b_SI_PANEL* SI_PANEL_EC + b_NO_ZER * NO_PANEL_EC +
  ...
  b_Info_traf * CONINFOTRF + b_NoInfo_traf * SININFOTRF +
