...
DBModoConduccion <- readRDS("/Users/williz/Desktop/ModelosED/1. Articulo 2/2. Database/DBModoCondCE.rds")


#Base de datos creada en DBPersonalidad.r
DBPersonalidad <- readRDS("/Users/williz/Desktop/ModelosED/1. Articulo 2/2. Database/DBPersonalidad.rds")
...
write.table(DBModelo, 
            file="/Users/williz/Desktop/ModelosED/1. Articulo 2/2. Database/ModeloLogitVL.csv", sep="\t", dec=".")
...
MCond = read.csv("/Users/williz/Desktop/ModelosED/2. Articulo 2/2. Database/DBCompleta_ModeloLogitVL.csv",sep="\t", dec=".",header=TRUE)
