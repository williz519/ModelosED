...
apollo_beta=c(asc_ruta1   = 0, asc_ruta2   = 0, asc_ruta3   = 0, asc_ruta4  = 0,
              ...
              #LV_1
              gamma_EDUBASICA_LV1 = -0.150,
              gamma_EDUSUP_LV1 = -0.415,
              gamma_EXP_2_LV1 = 0.087,
              gamma_EXP_5_LV1 = 0.115,
              gamma_HTRB_2_LV1 = 0.060,
              gamma_HPICO_LV1 = -0.099,
              gamma_CSECO_LV1 = 0.091,
              gamma_SININFOTRF_LV1 = -0.240,
              gamma_LV2_LV1 = 0.989,
              
              #LV_2
              gamma_EXP_3_LV2 = -0.126,
              gamma_EXP_4_LV2 = -0.192,
              gamma_EXP_5_LV2 = -0.108,
              gamma_HPICO_LV2 = 0.172,
              gamma_USODISPMOB_LV2 = -0.152,
              
              #LV_3
              gamma_EDUBASICA_LV3 = -0.307,
              gamma_EDUSUP_LV3 = 0.204,
              gamma_JOVEN30_LV3 = -0.540,
              gamma_ADULTO40_LV3 = -0.334,
              gamma_EXP_2_LV3 = 0.463,
              gamma_HTRB_2_LV3 = -0.970,
              gamma_HTRB_3_LV3 = -0.770,
              gamma_SININFOTRF_LV3 = 0.196,
              gamma_USODISPMOB_LV3 = -0.126,
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["LV_2"]] =  gamma_EXP_3_LV2*EXP_3 + gamma_EXP_4_LV2*EXP_4 +
    gamma_EXP_5_LV2*EXP_5 + gamma_HPICO_LV2*HPICO + gamma_USODISPMOB_LV2 * USODISPMOB + eta2
  
  randcoeff[["LV_1"]] = gamma_EDUBASICA_LV1*EDUBASICA + gamma_EDUSUP_LV1*EDUSUP + gamma_EXP_2_LV1*EXP_2 +
    gamma_EXP_5_LV1*EXP_5 + gamma_HTRB_2_LV1*HTRB_2 + gamma_HPICO_LV1*HPICO + gamma_CSECO_LV1*CSECO + 
    gamma_SININFOTRF_LV1*SININFOTRF + gamma_LV2_LV1*randcoeff[["LV_2"]] + eta1
  
  randcoeff[["LV_3"]] = gamma_EDUBASICA_LV3*EDUBASICA + gamma_EDUSUP_LV3*EDUSUP + gamma_JOVEN30_LV3*JOVEN30 + 
    gamma_ADULTO40_LV3*ADULTO40 + gamma_EXP_2_LV3*EXP_2 + gamma_HTRB_2_LV3*HTRB_2 + gamma_HTRB_3_LV3*HTRB_3 +
    gamma_SININFOTRF_LV3*SININFOTRF + gamma_USODISPMOB_LV3 * USODISPMOB + eta3
