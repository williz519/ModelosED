...
workingDirectory="/Users/williz/Desktop/ModelosED/2. Articulo 2/1. Scripts/Modelos de Prueba/ICVL_Conjunto-8F"
...
apollo_control = list(
  modelName  = "ICLV_Conjunto_8F Fusion2-3",
  modelDescr = "ICLV Conjunto de 8F",
  indivID    = "ViajeId",
  mixing     = TRUE,
  nCores     = 3
)
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["LV_1"]] = gamma_EDUBASICA*EDUBASICA + gamma_EXP_2*EXP_2 + gamma_HTRB_2*HTRB_2 +
    gamma_USODISPMOB * USODISPMOB + eta1
  
  randcoeff[["LV_5"]] = gamma_EDUBASICA*EDUBASICA + gamma_ADULTO40*ADULTO40 + gamma_EXP_1*EXP_1 +
    gamma_USODISPMOB * USODISPMOB + eta5
  
  randcoeff[["LV_4"]] = gamma_EDUBASICA*EDUBASICA + gamma_ADULTO60*ADULTO60 + gamma_SININFOTRF*SININFOTRF +
    gamma_USODISPMOB * USODISPMOB + gamma_LV1*randcoeff[["LV_1"]] + gamma_LV5*randcoeff[["LV_5"]] + eta4
  
  randcoeff[["LV_2"]] = gamma_EDUBASICA*EDUBASICA + gamma_JOVEN30*JOVEN30 + gamma_ADULTO40*ADULTO40 + gamma_ADULTO60*ADULTO60 +
    gamma_HTRB_2*HTRB_2 + gamma_HTRB_3*HTRB_3 + gamma_SININFOTRF*SININFOTRF + gamma_LV4*randcoeff[["LV_4"]] + eta2
  
  randcoeff[["LV_3"]] = gamma_EDUBASICA*EDUBASICA + gamma_ADULTO60*ADULTO60 + gamma_LV4*randcoeff[["LV_4"]] + eta3
  
  randcoeff[["LV_6"]] = gamma_EDUBASICA*EDUBASICA + gamma_HPICO*HPICO + gamma_CSECO*CSECO + gamma_SININFOTRF*SININFOTRF + 
    gamma_LV4*randcoeff[["LV_4"]] + eta6
  
  randcoeff[["LV_7"]] = gamma_JOVEN30*JOVEN30 + gamma_ADULTO40*ADULTO40 + gamma_ADULTO60*ADULTO60 +
    gamma_EXP_3*EXP_3 +  gamma_CSECO*CSECO + gamma_LV1*randcoeff[["LV_1"]] + eta7
  
  randcoeff[["LV_8"]] = gamma_EDUBASICA*EDUBASICA + gamma_ADULTO40*ADULTO40 + gamma_EXP_1*EXP_1 +
    gamma_EXP_3*EXP_3 + gamma_HPICO*HPICO + gamma_CSECO*CSECO + gamma_SININFOTRF*SININFOTRF + 
    gamma_USODISPMOB * USODISPMOB + gamma_LV1*randcoeff[["LV_1"]] + eta8
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ol_settings12 = list(outcomeOrdered=CulFr, 
                      V=zeta_CulFr*LV_5, 
                      tau=c(tau_CulFr_1, tau_CulFr_2, tau_CulFr_3, tau_CulFr_4))
  ...
  ol_settings13 = list(outcomeOrdered=UsoCel, 
                       V=zeta_UsoCel*LV_6, 
                       tau=c(tau_UsoCel_1, tau_UsoCel_2,tau_UsoCel_3,tau_UsoCel_4))
  ol_settings14 = list(outcomeOrdered=ComVrb, 
                      V=zeta_ComVrb * LV_6, 
                      tau=c(tau_ComVrb_1, tau_ComVrb_2, tau_ComVrb_3, tau_ComVrb_4))
  
  ol_settings15 = list(outcomeOrdered=UsoPito, 
                      V=zeta_UsoPito*LV_7, 
                      tau=c(tau_UsoPito_1, tau_UsoPito_2, tau_UsoPito_3, tau_UsoPito_4))
  ol_settings16 = list(outcomeOrdered=EnfCond, 
                      V=zeta_EnfCond*LV_7, 
                      tau=c(tau_EnfCond_1, tau_EnfCond_2, tau_EnfCond_3, tau_EnfCond_4))
  
  ol_settings17 = list(outcomeOrdered=IgPare, 
                      V=zeta_IgPare*LV_8, 
                      tau=c(tau_IgPare_1, tau_IgPare_2, tau_IgPare_3, tau_IgPare_4))
  ol_settings18 = list(outcomeOrdered=OmLmVel, 
                      V=zeta_OmLmVel*LV_8, 
  ...
  P[["indic_ComAfec"]]  = apollo_ol(ol_settings8, functionality)
  P[["indic_ConCl"]]    = apollo_ol(ol_settings9, functionality)
  P[["indic_ComVrb"]]   = apollo_ol(ol_settings10, functionality)
  
  P[["indic_UsoDirec"]]   = apollo_ol(ol_settings11, functionality)
  P[["indic_PasoPeaton"]] = apollo_ol(ol_settings12, functionality)
  P[["indic_UsoCel"]]     = apollo_ol(ol_settings13, functionality)
  P[["indic_CulFr"]]      = apollo_ol(ol_settings14, functionality)
  
  P[["indic_UsoCel"]]     = apollo_ol(ol_settings15, functionality)
  P[["indic_ComVrb"]]     = apollo_ol(ol_settings16, functionality)
  
  P[["indic_UsoPito"]]    = apollo_ol(ol_settings17, functionality)
  P[["indic_EnfCond"]]    = apollo_ol(ol_settings18, functionality)
  
  P[["indic_IgPare"]]     = apollo_ol(ol_settings19, functionality)
  P[["indic_OmLmVel"]]    = apollo_ol(ol_settings20, functionality)
