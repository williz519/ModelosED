...
apollo_beta=c(asc_ruta1   = 0, asc_ruta2   = 0, asc_ruta3   = 0, asc_ruta4  = 0,
              ...
              #LV_1
              gamma_HPICO_LV1 = -0.134,
              gamma_CSECO_LV1 = 0.190,
              gamma_SININFOTRF_LV1 = -0.195,
              gamma_LV2_LV1 = 0.999,
              
              #LV_2
              gamma_ADULTO40_LV2 = -0.182,
              gamma_HPICO_LV2 = -0.190,
              gamma_USODISPMOB_LV2 = 0.238,
              
              #LV_3
              gamma_EDUBASICA_LV3 = -0.401,
              gamma_JOVEN30_LV3 = -0.452,
              gamma_ADULTO40_LV3 = -0.232,
              gamma_EXP_2_LV3 = 0.359,
              gamma_USODISPMOB_LV3 = -0.259,
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["LV_2"]] = gamma_ADULTO40_LV2*ADULTO40 + gamma_HPICO_LV2*HPICO + 
    gamma_USODISPMOB_LV2 * USODISPMOB + eta2
  
  randcoeff[["LV_1"]] = gamma_HPICO_LV1*HPICO + gamma_CSECO_LV1*CSECO +
  ...
  randcoeff[["LV_3"]] = gamma_EDUBASICA_LV3*EDUBASICA + gamma_JOVEN30_LV3*JOVEN30 + 
    gamma_ADULTO40_LV3*ADULTO40 +  gamma_EXP_2_LV3*EXP_2 + gamma_USODISPMOB_LV3 * USODISPMOB + eta3
