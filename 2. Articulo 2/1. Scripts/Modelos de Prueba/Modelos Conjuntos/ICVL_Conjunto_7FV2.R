...
apollo_control = list(
  modelName  = "ICLV_Conjunto_7F_V2",
  modelDescr = "ICLV Conjunto de 7F_V2",
  indivID    = "ViajeId",
  mixing     = TRUE,
  nCores     = 3
)
...
apollo_beta=c(asc_ruta1   = 0, asc_ruta2   = 0, asc_ruta3   = 0, asc_ruta4  = 0,
              ...
              g_USODISPMOB_LV1 = 0.233,

              # Regresion LV2
              g_EDUBASICA_LV2 = 0.239,
              g_ADULTO60_LV2 = -0.167,
              g_EXP_2_LV2 = 0.755,
              g_EXP_3_LV2 = 0.384,
              g_EXP_4_LV2 = 0.410,
              g_EXP_5_LV2 = 0.399,
              ...
              g_JOVEN30_LV4 = -0.800,
              g_ADULTO40_LV4 = -0.550,
              g_ADULTO60_LV4 = -0.607,
              #g_EXP_2_LV4 = -0.481,
              #g_EXP_3_LV4 = -0.402,
              ...
              # Regresion LV5
              g_EDUBASICA_LV5 = -0.490,
              g_JOVEN30_LV5 = -0.605,
              g_ADULTO40_LV5 = -0.306,
              g_EXP_2_LV5 = 0.501,
              #g_HTRB_2_LV5 = -0.262,
              g_USODISPMOB_LV5 = -0.326,
              
              # Regresion LV6
              g_ADULTO40_LV6 = -0.169,
              #g_EXP_2_LV6 = -0.141,
              g_EXP_5_LV6 = -0.116,
              g_HPICO_LV6 = 0.156, 
              g_CSECO_LV6 = -0.200,
              g_SININFOTRF_LV6 = 0.126,
              #g_USODISPMOB_LV6 = 0.094,
              g_LV1_LV6 = 0.666,
              
              # Regresion LV7
              g_JOVEN30_LV7 = -0.348,
              g_ADULTO40_LV7 = -0.250,
              g_ADULTO60_LV7 = -0.233,
              g_EXP_2_LV7 = -0.190,
              g_EXP_5_LV7 = -0.148,
              #g_CSECO_LV7 = -0.145,
              g_LV1_LV7 = 0.787,
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["LV_5"]] = g_EDUBASICA_LV5*EDUBASICA + g_JOVEN30_LV5*JOVEN30 + g_ADULTO40_LV5*ADULTO40 + 
    g_EXP_2_LV5*EXP_2 + g_USODISPMOB_LV5*USODISPMOB + eta5
  ...
  randcoeff[["LV_3"]] = g_EDUBASICA_LV3*EDUBASICA + g_ADULTO60_LV3*ADULTO60 + 
    g_EXP_3_LV3*EXP_3 + g_LV1_LV3*randcoeff[["LV_1"]] + g_LV5_LV3*randcoeff[["LV_5"]] + eta3
  
  randcoeff[["LV_4"]] =  g_EDUBASICA_LV4*EDUBASICA + g_JOVEN30_LV4*JOVEN30 +  g_ADULTO40_LV4*ADULTO40 + 
    g_ADULTO60_LV4*ADULTO60 + g_SININFOTRF_LV4 *SININFOTRF +  g_LV3_LV4*randcoeff[["LV_3"]] + eta4

  randcoeff[["LV_2"]] = g_EDUBASICA_LV2*EDUBASICA +  g_ADULTO60_LV2*ADULTO60 + g_EXP_2_LV2*EXP_2 + 
    g_EXP_3_LV2*EXP_3 + g_EXP_4_LV2*EXP_4 + g_EXP_5_LV2*EXP_5 + g_LV3_LV2*randcoeff[["LV_3"]] + eta2
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ol_settings15 = list(outcomeOrdered=UsoCel, 
                      V=zeta_UsoCel*LV_6, 
                      tau=c(tau_UsoCel_1, tau_UsoCel_2,tau_UsoCel_3,tau_UsoCel_4))
  
  ol_settings16 = list(outcomeOrdered=UsoPito, 
                      V=zeta_UsoPito*LV_7, 
                      tau=c(tau_UsoPito_1, tau_UsoPito_2, tau_UsoPito_3, tau_UsoPito_4))
  ol_settings17 = list(outcomeOrdered=EnfCond, 
                      V=zeta_EnfCond*LV_7, 
  ...
  P[["indic_ComVrb"]]   = apollo_ol(ol_settings8, functionality)
  ...
  P[["indic_IgPare"]]     = apollo_ol(ol_settings13, functionality)
  P[["indic_OmLmVel"]]    = apollo_ol(ol_settings14, functionality)
  P[["indic_UsoCel"]]     = apollo_ol(ol_settings15, functionality)
  
  P[["indic_UsoPito"]]    = apollo_ol(ol_settings16, functionality)
  P[["indic_EnfCond"]]    = apollo_ol(ol_settings17, functionality)
