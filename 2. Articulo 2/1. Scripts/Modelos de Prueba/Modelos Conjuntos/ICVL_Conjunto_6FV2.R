...
apollo_beta=c(asc_ruta1   = 0, asc_ruta2   = 0, asc_ruta3   = 0, asc_ruta4  = 0,
              ...
              g_USODISPMOB_LV2 = 0.293,
              #g_EXP_4_LV2 = 0.410,
              #g_EXP_5_LV2 = 0.399,
              #g_LV3_LV2 = 0.712,
              
              # Regresion LV3
              g_EDUBASICA_LV3 = 0.211,
              #g_JOVEN30_LV3 = 0.329,
              ...
              g_JOVEN30_LV4 = -0.338,
              g_ADULTO40_LV4 = -0.291,
              g_ADULTO60_LV4 = -0.233,
              g_EXP_2_LV4 = -0.206,
              g_EXP_5_LV4 = -0.158,
              g_CSECO_LV4 = -0.170,
              ...
              g_JOVEN30_LV5 = 0.415,
              g_ADULTO40_LV5 = 0.297,
              g_ADULTO60_LV5 = 0.349,
              g_EXP_3_LV5 = -0.222,
              #g_HTRB_2_LV5 = -0.262,
              g_USODISPMOB_LV5 = 0.151,
              g_LV2_LV5 = 0.440,
              
              # Regresion LV6
              g_ADULTO40_LV6 = -0.184,
              #g_EXP_2_LV6 = -0.141,
              g_EXP_5_LV6 = -0.107,
              g_HPICO_LV6 = 0.152, 
              g_CSECO_LV6 = -0.199,
              g_SININFOTRF_LV6 = 0.140,
              g_USODISPMOB_LV6 = 0.113,
              g_LV1_LV6 = 0.645,
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["LV_2"]] =  g_ADULTO40_LV2*ADULTO40 +  g_ADULTO60_LV2*ADULTO60 + g_EXP_2_LV2*EXP_2 + 
    g_EXP_3_LV2*EXP_3  + g_SININFOTRF_LV2 *SININFOTRF + g_USODISPMOB_LV2*USODISPMOB + eta2
  
  randcoeff[["LV_5"]] = g_JOVEN30_LV5*JOVEN30 + g_ADULTO40_LV5*ADULTO40 + g_ADULTO60_LV5*ADULTO60 +
    g_EXP_3_LV5*EXP_3 + g_USODISPMOB_LV5*USODISPMOB + g_LV2_LV5*randcoeff[["LV_2"]] + eta5

  randcoeff[["LV_3"]] = g_EDUBASICA_LV3*EDUBASICA + g_EXP_2_LV3*EXP_2 + g_EXP_3_LV3*EXP_3 + 
    g_EXP_4_LV3*EXP_4 + g_EXP_5_LV3*EXP_5 + g_LV5_LV3*randcoeff[["LV_5"]] + eta3
  ...
  randcoeff[["LV_6"]] = g_ADULTO40_LV6*ADULTO40 +  g_EXP_5_LV6*EXP_5 + g_HPICO_LV6*HPICO + g_CSECO_LV6*CSECO +
    g_SININFOTRF_LV6 *SININFOTRF + g_USODISPMOB_LV6*USODISPMOB + g_LV1_LV6*randcoeff[["LV_1"]] + eta6
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  P[["indic_EnfCond"]]    = apollo_ol(ol_settings8, functionality)
  P[["indic_UsoCel"]]     = apollo_ol(ol_settings9, functionality)
  P[["indic_UsoPito"]]    = apollo_ol(ol_settings10, functionality)
  
  P[["indic_ConCl"]]    = apollo_ol(ol_settings11, functionality)
  P[["indic_ComAfec"]]  = apollo_ol(ol_settings12, functionality)
