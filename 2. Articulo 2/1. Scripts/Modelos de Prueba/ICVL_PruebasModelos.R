...
workingDirectory="/Users/williz/Desktop/ModelosED/2. Articulo 2/1. Scripts/Modelos de Prueba/ICVL_MCond_3F"
...
apollo_control = list(
  modelName  = "ICLV_MCond_3F Fusion2-3",
...
apollo_beta=c(asc_Op1   = 0, asc_Op2   = 0, asc_Op3 =0,
              ...
              #lambda3       = 1,
              gamma_JOVEN30 = -0.341,
              gamma_ADULTO40 = -0.274,
              gamma_EXP_2 = -0.321,
              gamma_HTRB_2 = 0.727,
              gamma_USODISPMOB1 =0.215,
              gamma_USODISPMOB2 =0.175,
              gamma_USODISPMOB3 =-0.380,
              gamma_EXP_1 = 0.097,
              gamma_HPICO = 0.154,
              gamma_CSECO = -0.178,
              gamma_SININFOTRF = 0.159,
              gamma_LV1 = 0.654,
              gamma_LV3 = 0.133,
              gamma_EDUBASICA = -0.357,
              gamma_HTRB_3 = -1.082,
...
apollo_randCoeff=function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["LV_1"]] = gamma_JOVEN30*JOVEN30 + gamma_ADULTO40*ADULTO40 + gamma_EXP_2*EXP_2 +
    gamma_HTRB_2*HTRB_2 + gamma_USODISPMOB1 * USODISPMOB + eta1
  
  randcoeff[["LV_3"]] = gamma_EDUBASICA*EDUBASICA + gamma_HTRB_2*HTRB_2 + gamma_HTRB_3*HTRB_3 +
    gamma_USODISPMOB3 * USODISPMOB + eta3
  
  randcoeff[["LV_2"]] = gamma_EXP_1*EXP_1 + gamma_HPICO*HPICO + gamma_CSECO*CSECO +
    gamma_SININFOTRF*SININFOTRF + gamma_USODISPMOB2 * USODISPMOB + gamma_LV1*randcoeff[["LV_1"]] +
    gamma_LV3*randcoeff[["LV_3"]] + eta2
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  P[["indic_UsoDirec"]]   = apollo_ol(ol_settings7, functionality)
  
  P[["indic_OmLmVel"]]    = apollo_ol(ol_settings8, functionality)
  P[["indic_IgPare"]]     = apollo_ol(ol_settings9, functionality)
  ...
  b_time_opc1 = b_time_opc1_ref * exp(b_time_opc1_CL1 * LV_1 + b_time_opc1_CL2 * LV_3)
  
  V[['Op1']]  = (asc_Op1  + b_time_opc1 * TIEMPOAlt1+ b_dt * DISTAlt1 + 
  ...
  b_time_opc2 = b_time_opc2_ref * exp(b_time_opc2_CL1 * LV_1 + b_time_opc2_CL2 * LV_3)
  
  V[['Op2']]  = (asc_Op2  + b_time_opc2 * TIEMPOAlt23+ b_dt * DISTAlt23 + 
  ...
  b_time_opc3 = b_time_opc3_ref * exp(b_time_opc3_CL1 * LV_1 + b_time_opc3_CL2 * LV_3)
  
  V[['Op3']] = (asc_Op3 + b_time_opc3 * TIEMPOEC   + b_dt * DISTEC + b_CongAB*CONG_AB_EC + 
