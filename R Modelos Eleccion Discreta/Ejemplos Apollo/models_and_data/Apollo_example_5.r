...
apollo_beta=apollo_readBeta(apollo_beta,apollo_fixed,"Apollo_example_4",overwriteFixed=FALSE)
...
apollo_lrTest("Apollo_example_4", "Apollo_example_5")
apollo_lrTest("Apollo_example_4", model)
