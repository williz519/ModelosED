...
@author: williz
"""
# Modelo de Elección MNL3
# Modelo básico con funciones de utilidad definidas en terminos del tiempo, distancias y
# las variables relacionadas a las caracteristicas del conductor como nivel educativo,
# Edad, tiempo en la profesión, horas que labora al día, uso del cinturon de seguridad 
...
V4 = ASC_EC+B_TIME*TIME4_SC+B_DIST*DIST4_SC+\
    COEF_TPROF*TPROF + COEF_HORASTRAB*HORASTRAB +\
    COEF_JOVEN30*JOVEN30 + COEF_ADULTO40*ADULTO40 + COEF_ADULTO60*ADULTO60+\
    COEF_EDUC_BASICA*EDUC_BASICA + COEF_USODISPMOB*USODISPMOB + COEF_USOCINTRURON*USOCINTURON
...
biogeme.modelName = "MNL3ChoiceMed"
