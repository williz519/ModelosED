...
# todas las variables incluidas en los modelos anteriores. 
...
V4 = ASC_EC+B_TIME*TIME4_SC+B_DIST*DIST4_SC+\
    COEF_SININFO*SININFO + COEF_USODISPMOB*USODISPMOB + COEF_CONGCD*CONGCD + COEF_CONGEF*CONGEF+\
    COEF_CLIMASECO*CLIMASECO+COEF_HORAPICO*HORAPICO + COEF_TPROF*TPROF + COEF_HORASTRAB*HORASTRAB +\
    COEF_JOVEN30*JOVEN30 + COEF_ADULTO40*ADULTO40 + COEF_ADULTO60*ADULTO60+\
    COEF_EDUC_BASICA*EDUC_BASICA + COEF_USOCINTRURON*USOCINTURON
...
biogeme.modelName = "MNL4ChoiceMed"
