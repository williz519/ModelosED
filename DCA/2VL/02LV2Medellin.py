...
COEF_INTER = Beta('COEF_INTER',-21.8,None,None,0)
COEF_EDUC_BASICA = Beta('COEF_EDUC_BASICA',2.05,None,None,0)
COEF_JOVEN30 = Beta('COEF_JOVEN30',2.05,None,None,0)
COEF_ADULTO40 = Beta('COEF_ADULTO40',-0.462	,None,None,0)
COEF_ADULTO60 = Beta('COEF_ADULTO60',-1.06,None,None,0)
COEF_ADULTOMAYOR = Beta('COEF_ADULTOMAYOR',0,None,None,0)
COEF_EDUC_SUPERIOR = Beta('COEF_EDUC_SUPERIOR',0,None,None,0)
COEF_TPROF = Beta('COEF_TPROF',0.0238,None,None,0)
COEF_HORASTRAB = Beta('COEF_HORASTRAB',-6.96,None,None,0)
COEF_HORAPICO = Beta('COEF_HORAPICO',1.87,None,None,0)
COEF_HVALLE = Beta('COEF_HVALLE',0,None,None,0)
COEF_CLIMASECO = Beta('COEF_CLIMASECO',1.19,None,None,0)
COEF_CLIMALLUVIA = Beta('COEF_CLIMALLUVIA',0,None,None,0)
COEF_CONGAB = Beta('COEF_CONGAB',0,None,None,0)
COEF_CONGCD = Beta('COEF_CONGCD',2.43,None,None,0)
COEF_CONGEF = Beta('COEF_CONGEF',5.34,None,None,0)
COEF_SININFO = Beta('COEF_SININFO',-1.98,None,None,0)
...
COEF_HABPROSOCF3 = Beta('COEF_HABPROSOCF3',12.5,None,None,0)
...
SIGMA_STAR_AmbTr = Beta('SIGMA_STAR_AmbTr',10,None,None,0)
