...
structResults = res.bioResults(pickleFile='02LV4MedellinOrdered.pickle')
...
COEF_JOVEN30 = Beta('COEF_JOVEN30',structBetas['COEF_JOVEN30'],-1000,1000,1)
...
omega_LV1 = RandomVariable('omega_LV1')
density_LV1 = dist.normalpdf(omega_LV1)
Beta_sigma_LV1 = Beta('Beta_sigma_LV1',10,0.01,None,0)

omega_LV2 = RandomVariable('omega_LV2')
density_LV2 = dist.normalpdf(omega_LV2)
Beta_sigma_LV2 = Beta('Beta_sigma_LV2',10,0.01,None,0)

omega_LV3 = RandomVariable('omega_LV3')
density_LV3 = dist.normalpdf(omega_LV3)
Beta_sigma_LV3 = Beta('Beta_sigma_LV3',10,0.01,None,0)

omega_LV4 = RandomVariable('omega_LV4')
density_LV4 = dist.normalpdf(omega_LV4)
...
prob_LV1 = Integrate(condprob * density_LV1,'omega_LV1')
prob_LV2 = Integrate(condprob * density_LV2,'omega_LV2')
prob_LV3 = Integrate(condprob * density_LV3,'omega_LV3')
prob_LV4 = Integrate(condprob * density_LV4,'omega_LV4')

loglike = log(prob_LV1*prob_LV2*prob_LV3*prob_LV4)

biogeme  = bio.BIOGEME(database,loglike)

biogeme.modelName = "04LV4ChoiceSeqInt"
