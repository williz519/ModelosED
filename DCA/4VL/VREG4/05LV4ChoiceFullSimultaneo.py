...
# Coeficientes
structResults = res.bioResults(pickleFile='/Users/williz/Desktop/ModelosED/DCA/3VL/02LV3REGMedellinOrdered.pickle')
...
## MODELO DE ELECCION
#Leer las estimaciones de la estimacion secuencial
choiceResults = res.bioResults(pickleFile='/Users/williz/Desktop/ModelosED/DCA/4VL/VREG2/04LV4REGChoiceSeqMedV2.pickle')
choiceBetas = choiceResults.getBetaValues()

#Coeficientes Variables Latentes
B_ACTAGRE = Beta('B_ACTAGRE',choiceBetas['B_ACTAGRE'],None,None,0)
B_AMBLABOR = Beta('B_AMBLABOR',choiceBetas['B_AMBLABOR'],None,None,0)
B_HABPROSOC = Beta('B_HABPROSOC',choiceBetas['B_HABPROSOC'],None,None,0)
B_STRESS = Beta('B_STRESS',choiceBetas['B_STRESS'],None,None,0)
...
B_TIME = Beta('B_TIME',choiceBetas['B_TIME'],None,None,0)
...
condlike = P_FRbr*P_EnfCond*P_AFrSem*P_CulFr*P_OmLmVel*P_IgPare*P_UsoCel*P_PrPer*P_AmbTr*\
...
biogeme.modelName = "05LV4ChoiceSimultaneo"
