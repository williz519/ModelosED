...
INTER_EnfCond = Beta('INTER_EnfCond',-3.12,None,None,0)
INTER_AFrSem = Beta('INTER_AFrSem',-0.414,None,None,0)
INTER_CulFr = Beta('INTER_CulFr',3.53,None,None,0)
INTER_OmLmVel = Beta('INTER_OmLmVel',-3.09,None,None,0)
INTER_IgPare = Beta('INTER_IgPare',-3.63,None,None,0)
INTER_UsoCel = Beta('INTER_UsoCel',-6.36,None,None,0)
...
SIGMA_STAR_EnfCond = Beta('SIGMA_STAR_EnfCond', 7.2,None,None,0)
SIGMA_STAR_AFrSem = Beta('SIGMA_STAR_AFrSem',8.91,None,None,0)
SIGMA_STAR_CulFr = Beta('SIGMA_STAR_CulFr', 10.1,None,None,0)
SIGMA_STAR_OmLmVel = Beta('SIGMA_STAR_OmLmVel', 8.18,None,None,0)
SIGMA_STAR_IgPare = Beta('SIGMA_STAR_IgPare', 7.05,None,None,0)
SIGMA_STAR_UsoCel = Beta('SIGMA_STAR_UsoCel', 9.59,None,None,0)


### ECUACIONES DE MEDIDA FACTOR AMBIENTE LABORAL

INTER_PrPer= Beta('INTER_PrPer',0,None,None,1)
INTER_AmbTr= Beta('INTER_AmbTr',-9.8,None,None,0)
...
SIGMA_STAR_AmbTr = Beta('SIGMA_STAR_AmbTr',12.2,None,None,0)


### ECUACIONES DE MEDIDA FACTOR HABILIDADES PROSOCIALES

INTER_ComVrb = Beta('INTER_ComVrb',0,None,None,1)
INTER_ComAfec = Beta('INTER_ComAfec',-25,None,None,0)
INTER_ConCl = Beta('INTER_ConCl',-25.7,None,None,0)
INTER_AnsF3 = Beta('INTER_AnsF3',-17.8,None,None,0)
...
SIGMA_STAR_ComAfec = Beta('SIGMA_STAR_ComAfec',13.4,None,None,0)
SIGMA_STAR_ConCl = Beta('SIGMA_STAR_ConCl',10.6,None,None,0)
SIGMA_STAR_AnsF3 = Beta('SIGMA_STAR_AnsF3',9.64,None,None,0)
