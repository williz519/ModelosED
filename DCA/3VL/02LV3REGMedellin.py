...
# Coeficientes
structResults = res.bioResults(pickleFile='/Users/williz/Desktop/ModelosED/DCA/2VL/02LV2MedellinOrdered.pickle')
...
ACTAGR = COEF_INTER + COEF_EDUC_BASICA*EDUC_BASICA+COEF_JOVEN30*JOVEN30 +\
    ...
    COEF_CONGCD*CONGCD + COEF_CONGEF*CONGEF+COEF_USOCINTURON*USOCINTURON + COEF_STRESSF4*STRESSF4
...
AMBLABOR = COEF_INTER + COEF_EDUC_BASICA*EDUC_BASICA + COEF_ADULTO40*ADULTO40+\
    ...
    COEF_CONGCD*CONGCD + COEF_CONGEF*CONGEF + COEF_USOCINTURON*USOCINTURON +COEF_USODISPMOB*USODISPMOB
...
HABPROSOC = COEF_INTER + COEF_ADULTO40*ADULTO40 + COEF_ADULTO60*ADULTO60+\
    ...
    COEF_USOCINTURON*USOCINTURON + COEF_AMBLABORF2*AMBLABORF2
...
loglike = log(P_FRbr * P_EnfCond * P_AFrSem * P_CulFr * P_OmLmVel * P_IgPare * P_UsoCel * P_PrPer * P_AmbTr *\
    P_ComVrb * P_ComAfec * P_ConCl)
            

biogeme  = bio.BIOGEME(database,loglike)
biogeme.modelName = "02LV3REGMedellinOrdered"
